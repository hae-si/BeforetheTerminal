...
public class Noellesroles implements ModInitializer {
    ...
    public static Role JESTER = WatheRoles.registerRole(new Role(JESTER_ID,new Color(0,255,255).getRGB() ,false,false, Role.MoodType.FAKE,Integer.MAX_VALUE,true));
    public static Role MORPHLING =WatheRoles.registerRole(new Role(MORPHLING_ID, new Color(244,0,161).getRGB(),false,true, Role.MoodType.FAKE,Integer.MAX_VALUE,true));
    public static Role CONDUCTOR =WatheRoles.registerRole(new Role(CONDUCTOR_ID, new Color(102,255,0).getRGB(),true,false, Role.MoodType.REAL,WatheRoles.CIVILIAN.getMaxSprintTime(),false));
    ...
    public static Role BARTENDER =WatheRoles.registerRole(new Role(BARTENDER_ID, new Color(244,0,161).getRGB(),true,false, Role.MoodType.REAL,WatheRoles.CIVILIAN.getMaxSprintTime(),false));
    public static Role NOISEMAKER =WatheRoles.registerRole(new Role(NOISEMAKER_ID, new Color(255,192,203).getRGB(),true,false, Role.MoodType.REAL,WatheRoles.CIVILIAN.getMaxSprintTime(),false));
    public static Role SWAPPER = WatheRoles.registerRole(new Role(SWAPPER_ID, new Color(139,0,139).getRGB(),false,true, Role.MoodType.FAKE,Integer.MAX_VALUE,true));
    public static Role PHANTOM =WatheRoles.registerRole(new Role(PHANTOM_ID, new Color(244,0,161,192).getRGB(),false,true, Role.MoodType.FAKE,Integer.MAX_VALUE,true));
    ...
    public static Role VOODOO =WatheRoles.registerRole(new Role(VOODOO_ID, new Color(128,0,128).getRGB(),true,false,Role.MoodType.REAL, WatheRoles.CIVILIAN.getMaxSprintTime(),false));
    ...
    public static Role CORONER =WatheRoles.registerRole(new Role(CORONER_ID, new Color(255,102,0).getRGB(),true,false,Role.MoodType.REAL, WatheRoles.CIVILIAN.getMaxSprintTime(),false));
    ...
    public static Role VULTURE =WatheRoles.registerRole(new Role(VULTURE_ID, new Color(205,127,50).getRGB(),false,false,Role.MoodType.FAKE, WatheRoles.CIVILIAN.getMaxSprintTime(),true));
    public static Role INFECTED =WatheRoles.registerRole(new Role(INFECTED_ID, new Color(205,127,50).getRGB(),false,false,Role.MoodType.FAKE, WatheRoles.CIVILIAN.getMaxSprintTime(),true));
    ...
    // C-043：GUESSER Role 恢复（刺客接管；字段名避开 GUESSER modifier）
    public static Role GUESSER_ROLE = WatheRoles.registerRole(new Role(GUESSER_ID, new Color(128, 0, 0).getRGB(), false, true, Role.MoodType.FAKE, Integer.MAX_VALUE, true));

    public static Role MIMIC = WatheRoles.registerRole(new Role(MIMIC_ID, new Color(64,224,208).getRGB(),true,false,Role.MoodType.REAL, WatheRoles.CIVILIAN.getMaxSprintTime(),false));
